  ...
  const cardData = [
    {
      date: "17 thg 11, 2022",
      title:
        "The 9 next big things, from fairer refinancing to kid-friendly voice recognition",
      author: "Fast Company",
      icon: <GiTechnoHeart />,
      image:
    ...
    },
    {
      ...
      icon: <GiTechnoHeart />,
      image:
        "https://images.unsplash.com/photo-1584432743501-7d5c27a39189?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bmljZSUyMHZpZXd8ZW58MHx8MHx8fDA%3D&w=1000&q=80",
    },
    {
      date: "17 thg 11, 2022",
      title:
    ...
    },
    {
      ...
      icon: <GiTechnoHeart />,
      image:
        "https://ik.imagekit.io/tvlk/blog/2022/10/quan-cafe-view-dep-sai-gon-13.jpg",
    },
    {
      date: "17 thg 11, 2022",
      title:
      ...
      icon: <GiTechnoHeart />,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZkQRledRVCysJ2RshnnlDwWCfpilzJbuuyg&usqp=CAU",
    },
  ];
    ...
    <div>
      <Card className="pb-4">
        <CardBody>
          ...
          <Row className={style.aboutDetail}>
            <Col>
              <h2 className={style.aboutHeadingFirst}>
                {t("title_homePage.makingEveryStudentUnstoppable")}
              </h2>
              <br />
              <p>
                {t("title_homePage.makingEveryStudentUnstoppable_DetailFirst")}
              </p>
              <p>
                {t("title_homePage.makingEveryStudentUnstoppable_DetailSecond")}
              </p>
              <br />
              <Button color="primary">
                {t("btn_homePage.readOutImpactReport")}
              </Button>
            </Col>

            <Col>
              <img
                className={style.aboutDetailImg}
                src="https://img.freepik.com/premium-photo/vertical-shot-happy-group-students-studying-working-together-college-multiracial-caucasian-girls-sitting-table_533057-1396.jpg"
                alt="image error"
              />
            </Col>
          </Row>
        ...
        <CardBody className="pb-5 pt-5">
          <Row className={style.aboutDetailSecond}>
            <Col className={style.aboutDetailSecond_Col}>
              <img
                className={style.aboutDetailImg}
                src="https://media.istockphoto.com/id/882968778/photo/students-in-library.jpg?s=612x612&w=0&k=20&c=cHNDsDz90k5sqx52GSD4X742J_Li_zmQOM8GxjmLm2g="
                alt="image error"
              />
            </Col>

            <Col>
              <h2 className={`${style.aboutHeadingSecond}`}>
                {t("title_homePage.fromSingleClassroomToSchools")}
              </h2>
              <br />
      ...
      <div className="mb-3" style={{ marginTop: "6rem" }}>
        <h2 className="fw-bolder mb-3">
          <FcIdea size={35} className="mb-1" />
          &nbsp;{t("advantages_homePage.advantages")}
        </h2>
      ...
      <div className="mt-5 mb-3">
        <h2 className="fw-bolder">
          <FcIdea size={35} className="mb-1" />
          &nbsp;{t("slider_homePage.Recent_press")}
        </h2>
        <div className={style.slider}>
          <label
            className={style.sliderCardButtonPrev}
          ...
          <label
            className={style.sliderCardButtonNext}
      ...
      <div className="mb-4">
        <h2 className="mb-3 fw-bolder">
          <FcIdea size={35} className="mb-1" />
          &nbsp;{t("ourPartners_homePage.ourPartners")}
        </h2>
        <div className={style.ourPartnerSection}>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/6ae6531d-9921-446b-906a-524ae6b7124e_GA+Logo.svg"
              alt="logo error"
            />
          </div>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/5e63e134-0c1e-4022-840a-c7acd8c48905_icon_logo-01.svg"
              alt="logo error"
            />
          </div>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/3b9cdb6a-4f4b-46bf-960d-0875ebd468ce_USV+Logo+final2.svg"
              alt="logo error"
            />
          </div>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/02f0b0af-591e-4dec-b286-bbe85fe2a214_Costanoa-Ventures.svg"
              alt="logo error"
            />
          </div>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/7c0f7042-d266-4ffe-8969-732c55399347_OV+Logofinal.svg"
              alt="logo error"
            />
          </div>
          <div className={style.ourPartnerItem}>
            <img
              src="https://quizlet-web.cdn.prismic.io/quizlet-web/15f31d47-50f1-45bb-8c84-98b79aff8d85_AV+LogoFINAL1.svg"
              alt="logo error"
            />
          </div>
        </div>
            ...
            <div className={style.contactUsContent}>
              ...
              <h5 className="mt-2">
                <span className="fw-bolder">
                  {t("contactUs_homePage.phone")}: &nbsp;
                </span>
                <span
                  className={`${style.contactUs_span} pb-2`}
                ...
                <br />
                <span className="fw-bolder">
                  {t("contactUs_homePage.location")}: &nbsp;
                </span>
                <span className={`${style.contactUs_span} pt-2`}>
                  {" "}
                ...
                <span
                  className={`${style.contactUs_span} pt-2`}
                  style={{ textDecoration: "underline" }}
                >
                  Quizroom@company.com
                </span>
              </h5>
            </div>
              ...
              <div className={style.contactUs_section_containerItem}>
                <div className={style.contactUs_section_containerItem_block}>
                  <h5>
                    ...
                    {t("contactUs_homePage.location_upper")}
                  </h5>
                  <p>
